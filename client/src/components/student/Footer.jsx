      ...
      justify-center gap-10 md:gap-32 py-10 border-b border-white/30 '>
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
          ...
          <div className='flex items-center gap-2 pt-4'>
            ...
            placeholder-gray-500 outline-none w-64 h-9 rounded px-2 text-sm' type="email" placeholder='Enter your email' name="" id="" />
            <button className='bg-blue-600 w-24 h-9 text-white rounded'>Subscribe</button>
          </div>
        </div>
      </div>
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 © SkilledBased Pro. All Right Reserved.</p>
    </footer>
  ) 
}
